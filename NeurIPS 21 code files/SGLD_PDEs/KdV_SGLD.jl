...
eq  = Dt(u(t,x)) ~ -Dxxx(u(t,x)) - 6*u(t,x) * Dx(u(t,x))
...
domains = [t ∈ IntervalDomain(0.0,0.5),
...
cmap = get_cmap("RdBu")
pcolormesh(xgrid,tgrid,sol',rasterized=true)
xticks([], [])
...
loss2 = sum(abs2, training_data .- pred)
...
trainlosses, parameters_kdv = results;

using JLD2, LaTeXStrings

JLD2.@save "C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/kdv_Data_SGLD.jld2" results training_data trainlosses  parameters_kdv

JLD2.@load "C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/kdv_Data_SGLD.jld2" results training_data trainlosses  parameters_kdv
...
ylabel(L"$t$"); title(string("KdV equation: ",  L"$u_{t} = - u_{xxx} - 6 u u_{x}$",  "\n", "Data"))
...
ax = subplot(312)
cur_pred = predict_rd(parameters_kdv[end-rand(1:600), :])
...
fig.savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/Kdv_Colormesh_noresize_SGLD.pdf")
